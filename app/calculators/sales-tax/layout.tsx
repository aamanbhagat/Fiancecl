...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://calculatorhub.space/calculators/sales-tax",
    images: [
      {
  ...
  // alternates: {
  //   canonical: "https://calculatorhub.space/calculators/sales-tax"
  // }
}
...
export default function SalesTaxCalculatorLayout({
  ...
  return (
    <>
      <link 
        rel="canonical" 
        href="https://calculatorhub.space/calculators/sales-tax" 
      />
      {children}
    </>
  )
