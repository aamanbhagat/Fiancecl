...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://calculatorhub.space/calculators/mortgage-payoff",
    images: [
      {
  ...
  // alternates: {
  //   canonical: "https://calculatorhub.space/calculators/mortgage-payoff"
  // }
}
...
export default function MortgagePayoffCalculatorLayout({
  ...
  return (
    <>
      <link 
        rel="canonical" 
        href="https://calculatorhub.space/calculators/mortgage-payoff" 
      />
      {children}
    </>
  )
