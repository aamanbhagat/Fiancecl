...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://calculatorshub.store/calculators/real-estate",
    images: [
      {
  ...
  // alternates: {
  //   canonical: "https://calculatorshub.store/calculators/real-estate"
  // }
}
...
export default function RealEstateCalculatorLayout({
  ...
  return (
    <>
      <link 
        rel="canonical" 
        href="https://calculatorshub.store/calculators/real-estate" 
      />
      {children}
    </>
  )
