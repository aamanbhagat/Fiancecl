  ...
  return {
    ...
    '@graph': [
      // WebApplication schema for the calculator itself
      {
        ...
        'screenshot': {
          '@type': 'ImageObject',
          'url': '/images/calculators/simple-interest-screenshot.jpg'
        }
      },
      ...
      // BreadcrumbList schema for navigation
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Simple Interest Calculator',
            'item': '/calculators/simple-interest'
          }
        ]
      },
  ...
  return (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify(generateSimpleInterestSchema(process.env.NEXT_PUBLIC_SITE_URL + '/calculators/simple-interest')),
      }}
    />
  );
}