...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://calculatorshub.store/calculators/payback-period",
    images: [
      {
  ...
  // alternates: {
  //   canonical: "https://calculatorshub.store/calculators/payback-period"
  // }
}
...
export default function PaybackPeriodCalculatorLayout({
  ...
  return (
    <>
      <link 
        rel="canonical" 
        href="https://calculatorshub.store/calculators/payback-period" 
      />
      {children}
    </>
  )
