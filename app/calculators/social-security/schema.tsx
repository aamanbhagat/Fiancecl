  ...
  return {
    ...
    '@graph': [
      // WebApplication schema for the calculator itself
      {
        ...
        'screenshot': {
          '@type': 'ImageObject',
          'url': '/images/calculators/social-security-screenshot.jpg'
        }
      },
      ...
      // BreadcrumbList schema for navigation
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Social Security Calculator',
            'item': '/calculators/social-security'
          }
        ]
      },
  ...
  return (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify(generateSocialSecuritySchema(process.env.NEXT_PUBLIC_SITE_URL + '/calculators/social-security')),
      }}
    />
  );
}