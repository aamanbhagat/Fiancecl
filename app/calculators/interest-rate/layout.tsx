...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://calculatorhub.space/calculators/interest-rate",
    images: [
      {
  ...
  // alternates: {
  //   canonical: "https://calculatorhub.space/calculators/interest-rate"
  // }
}
...
export default function InterestRateCalculatorLayout({
  ...
  return (
    <>
      <link 
        rel="canonical" 
        href="https://calculatorhub.space/calculators/interest-rate" 
      />
      {children}
    </>
  )
