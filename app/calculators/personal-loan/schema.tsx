  ...
  return {
    ...
    '@graph': [
      // WebApplication schema for the calculator itself
      {
        ...
        'screenshot': {
          '@type': 'ImageObject',
          'url': '/images/calculators/personal-loan-screenshot.jpg'
        }
      },
      ...
      // BreadcrumbList schema for navigation
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Personal Loan Calculator',
            'item': '/calculators/personal-loan'
          }
        ]
      },
  ...
  return (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify(generatePersonalLoanSchema(process.env.NEXT_PUBLIC_SITE_URL + '/calculators/personal-loan')),
      }}
    />
  );
}