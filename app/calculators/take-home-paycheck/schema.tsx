  ...
  return {
    ...
    '@graph': [
      // WebApplication schema for the calculator itself
      {
        ...
        'screenshot': {
          '@type': 'ImageObject',
          'url': '/images/calculators/take-home-paycheck-screenshot.jpg'
        }
      },
      ...
      // BreadcrumbList schema for navigation
      {
        ...
        'itemListElement': [
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Take-Home Paycheck Calculator',
            'item': '/calculators/take-home-paycheck'
          }
        ]
      },
  ...
  return (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify(generateTakeHomePaycheckSchema(process.env.NEXT_PUBLIC_SITE_URL + '/calculators/take-home-paycheck')),
      }}
    />
  );
}