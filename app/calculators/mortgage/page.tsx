  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        {/* How to Use Section */}
        <section className="py-12 bg-muted/30 dark:bg-muted/10 border-t">
          <div className="container max-w-4xl">
            <h2 className="text-2xl font-bold mb-8 text-center">How to Use This Mortgage Calculator</h2>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Enter Loan Details</h3>
                    <p className="text-sm text-muted-foreground">Input the total loan amount and interest rate. Adjust the loan term (usually 30 or 15 years) to see how it affects your monthly payment.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Set Down Payment</h3>
                    <p className="text-sm text-muted-foreground">Use the slider or input field to set your down payment percentage. A higher down payment (20%+) can help you avoid Private Mortgage Insurance (PMI).</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Include Taxes & Fees</h3>
                    <p className="text-sm text-muted-foreground">Don't forget property taxes, homeowners insurance, and HOA fees. These significantly increase your actual monthly housing cost.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Analyze the Breakdown</h3>
                    <p className="text-sm text-muted-foreground">Check the pie chart to see where your money goes. In the early years, most of your payment goes toward interest rather than principal.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary font-bold">5</div>
                  <div>
                    <h3 className="font-semibold mb-1">Test Prepayment Strategies</h3>
                    <p className="text-sm text-muted-foreground">Use the &quot;Extra Payment&quot; field to see how much interest you can save by paying a little more each month. Even $50 extra can save thousands.</p>
                  </div>
                </div>

                <div className="flex gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary font-bold">6</div>
                  <div>
                    <h3 className="font-semibold mb-1">Download & Share</h3>
                    <p className="text-sm text-muted-foreground">Export your results as a PDF using the download button, or better yet, print the amortization schedule for your records.</p>
                  </div>
                </div>
              </div>
            </div>
