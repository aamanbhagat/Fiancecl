  ...
  return {
    ...
    '@graph': [
      // WebApplication schema for the calculator itself
      {
        ...
        'screenshot': {
          '@type': 'ImageObject',
          'url': '/images/calculators/repayment-screenshot.jpg'
        }
      },
  ...
  return (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify(generateRepaymentSchema(process.env.NEXT_PUBLIC_SITE_URL + '/calculators/repayment')),
      }}
    />
  );
}