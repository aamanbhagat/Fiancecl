...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://calculatorshub.store/calculators/down-payment",
    images: [
      {
  ...
  // alternates: {
  //   canonical: "https://calculatorshub.store/calculators/down-payment"
  // }
}
...
export default function DownPaymentCalculatorLayout({
  ...
  return (
    <>
      <link 
        rel="canonical" 
        href="https://calculatorshub.store/calculators/down-payment" 
      />
      {children}
    </>
  )
